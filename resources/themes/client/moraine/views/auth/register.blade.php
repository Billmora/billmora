...
<body class="bg-white">
    <div class="flex flex-col lg:flex-row-reverse w-full min-h-dvh lg:items-start p-8 lg:p-0">
        ...
        <div class="sticky top-0 w-auto max-w-180 lg:max-w-none lg:w-1/2 h-auto lg:h-dvh lg:flex justify-center bg-billmora-primary mx-auto rounded-2xl lg:rounded-none lg:rounded-br-[100px]">
