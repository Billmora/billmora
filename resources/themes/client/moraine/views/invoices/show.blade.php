...
<div class="flex flex-col lg:flex-row gap-5">
    <div class="w-full lg:w-5/7 h-fit grid gap-8 bg-white p-8 border-2 border-billmora-2 rounded-2xl">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-0 items-center">
            ...
            <div class="grid gap-2 col-span-4">
                <div class="grid grid-cols-2">
                    ...
                    <span class="font-semibold text-slate-500">{{ $invoice->created_at->toDateString() }}</span>
                </div>
                <div class="grid grid-cols-2">
                    <span class="font-semibold text-slate-600">{{ __('client/invoice.due_date') }}</span>
                    <span class="font-semibold text-slate-500">{{ $invoice->due_date->toDateString() }}</span>
                </div>
            </div>
        </div>
                    ...
                    <table class="min-w-full divide-y-2 divide-billmora-2">
                        <thead class="bg-billmora-2">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-4 text-start text-xs font-semibold text-slate-500 uppercase">{{ __('client/invoice.price') }}</th>
