    ...
    <div class="container">
                ...
                <tr>
                    <td class="left">
                        <div class="client-info">
                            <div style="margin-top: 10px;">
                                <span class="label">{{ __('client/invoices.invoice_number_label') }}</span>
                                <span class="value">#{{ $invoice->invoice_number }}</span>
                            </div>
                            <div style="margin-top: 10px;">
                                <span class="label">{{ __('client/invoices.bill_to_label') }}</span>
                                <span class="value">{{ $invoice->user->fullname }}</span>
                            </div>
                            <div style="margin-top: 5px;">
                                <span class="label">{{ __('client/invoices.currency_label') }}</span>
                    ...
                    <td class="right">
                        <div class="invoice-meta">
                            ...
                            <div style="margin-top: 10px;">
                                <span class="label">{{ __('client/invoices.invoice_date_label') }}</span>
                                <span class="value">{{ $invoice->created_at->format(Billmora::getGeneral('company_date_format')) }}</span>
                            </div>
                            <div style="margin-top: 5px;">
                                <span class="label">{{ __('client/invoices.due_date_label') }}</span>
        ...
        <div class="items-section">
            ...
            <table>
                <thead>
                    <tr>
                        <th style="width: 50%;">{{ __('client/invoices.description_label') }}</th>
                        <th style="width: 12%; text-align: center;">{{ __('client/invoices.quantity_label') }}</th>
                        <th style="width: 18%; text-align: right;">{{ __('client/invoices.unit_price_label') }}</th>
                        <th style="width: 20%; text-align: right;">{{ __('client/invoices.amount_label') }}</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <td class="right">
                        <div class="totals-content">
                            <div class="total-row">
                                <table>
                                    <tr>
                                        <td class="label">{{ __('client/invoices.subtotal_label') }}</td>
                            ...
                            @if($invoice->discount > 0)
                                <div class="total-row">
                                    <table>
                                        <tr>
                                            <td class="label">{{ __('client/invoices.discount_label') }}</td>
                            ...
                            <div class="grand-total">
                                <table>
                                    <tr>
                                        <td class="label">{{ __('client/invoices.total_due_label') }}</td>
