...
<div class="flex flex-col gap-4">
    ...
    <div class="flex flex-col md:flex-row gap-4 justify-between items-center">
        ...
        @can('transactions.create')
            <a href="{{ route('admin.invoices.transaction.create', ['invoice' => $invoice->id]) }}" class="flex gap-1 items-center bg-billmora-primary-500 hover:bg-billmora-primary-600 px-3 py-2 ml-auto text-white rounded-lg transition-colors ease-in-out duration-150 cursor-pointer">
