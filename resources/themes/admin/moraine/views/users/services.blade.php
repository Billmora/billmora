                        ...
                        @foreach ($services as $service)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium space-x-2">
                                    @can('services.update')
                                        <a href="{{ route('admin.services.edit', ['service' => $service->id]) }}" class="inline-flex items-center text-sm font-semibold text-billmora-primary hover:text-billmora-primary-hover">
                                            {{ __('common.edit') }}
                                        </a>                               
                                    @endcan
                                </td>
