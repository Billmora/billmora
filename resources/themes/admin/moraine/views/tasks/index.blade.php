                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-800">
                                    @if(isset($props['service_id']))
                                        <a href="{{ route('admin.services.edit', ['service' => $props['service_id']]) }}" class="inline-flex items-center text-sm font-semibold text-billmora-primary hover:text-billmora-primary-hover">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium space-x-2">
                                    <a href="{{ route('admin.audits.system.show', ['system' => $task->id]) }}" class="inline-flex items-center text-sm font-semibold text-billmora-primary hover:text-billmora-primary-hover">
                                        {{ __('common.view') }}
                                    </a>
                                    @can('tasks.retry')
