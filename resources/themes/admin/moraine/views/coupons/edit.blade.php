    ...
    <div class="flex flex-col gap-4 w-full h-fit bg-white p-8 border-2 border-billmora-2 rounded-2xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                >
                    <option value="" {{ old('coupon_client_restriction', $coupon->client_restriction) === '' || old('coupon_client_restriction', $coupon->client_restriction) === null ? 'selected' : '' }}>None</option>
                    <option value="new_client" {{ old('coupon_client_restriction', $coupon->client_restriction) === 'new_client' ? 'selected' : '' }}>New Clients Only</option>
                    <option value="existing_client" {{ old('coupon_client_restriction', $coupon->client_restriction) === 'existing_client' ? 'selected' : '' }}>Existing Clients Only</option>
                </x-admin::select>
            </div>
            <x-admin::input
