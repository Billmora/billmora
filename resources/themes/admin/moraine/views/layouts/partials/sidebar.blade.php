...
<nav id="sidebar" class="fixed z-100 xl:sticky top-0 left-0 xl:block shrink-0 p-5 xl:pr-0 w-[350px] sm:w-[400px] h-dvh -translate-x-full xl:translate-x-0 transition-transform duration-300 ease-in-out">
  <div class="bg-white flex flex-col w-full h-full border-2 border-billmora-2 rounded-2xl p-8">
    ...
    <div class="w-full flex gap-4 mt-auto pt-4">
        <a href="https://billmora.com/docs/introduction" target="_blank" class="flex justify-center gap-1 items-center bg-billmora-2 hover:bg-billmora-primary-hover px-3 py-2 text-billmora-primary hover:text-white font-semibold rounded-lg transition-colors ease-in-out duration-150 cursor-pointer">
            <x-lucide-book class="w-auto h-5" />
            Documentation
        </a>
        <a href="https://github.com/sponsors/Billmora" target="_blank" class="w-full flex justify-center gap-1 items-center bg-billmora-2 hover:bg-billmora-primary-hover px-3 py-2 text-billmora-primary hover:text-white font-semibold rounded-lg transition-colors ease-in-out duration-150 cursor-pointer">
