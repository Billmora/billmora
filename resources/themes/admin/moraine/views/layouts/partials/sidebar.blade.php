...
<nav id="sidebar" class="fixed z-100 xl:sticky top-0 left-0 xl:block shrink-0 p-5 xl:pr-0 w-[350px] sm:w-[400px] h-dvh -translate-x-full xl:translate-x-0 transition-transform duration-300 ease-in-out">
  <div class="bg-white flex flex-col w-full h-full border-2 border-billmora-2 rounded-2xl p-8">
    ...
    <div class="space-y-2 overflow-y-auto" id="sidemenu">
      {{-- Sidebar content --}}
      <a href="{{ route('admin.dashboard') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.dashboard') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
      ...
      @can('users.view')
        <a href="{{ route('admin.users') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.users*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
          <x-lucide-users class="w-5 h-auto" />
          <span class="font-semibold">{{ __('admin/navigation.users') }}</span>
        </a>
      @endcan
      @can('orders.view')
        <a href="{{ route('admin.orders') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.orders*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
      ...
      @canany(['services.view', 'services.cancellations.view'])
        <a href="{{ route('admin.services') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.services*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
          <x-lucide-scan-text class="w-5 h-auto" />
          <span class="font-semibold">{{ __('admin/navigation.services') }}</span>
        </a>
      @endcan
      @can('invoices.view')
        <a href="{{ route('admin.invoices') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.invoices*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
          <x-lucide-receipt-text class="w-5 h-auto" />
          <span class="font-semibold">{{ __('admin/navigation.invoices') }}</span>
        </a>
      @endcan
      @can('transactions.view')
        <a href="{{ route('admin.transactions') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.transactions*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
          <x-lucide-landmark class="w-5 h-auto" />
          <span class="font-semibold">{{ __('admin/navigation.transactions') }}</span>
        </a>
      @endcan
      @can('broadcasts.view')
        <a href="{{ route('admin.broadcasts') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.broadcasts*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
          <x-lucide-radio class="w-5 h-auto" />
          <span class="font-semibold">{{ __('admin/navigation.broadcasts') }}</span>
        </a>
      @endcan
      @can('tickets.view')
        <a href="{{ route('admin.tickets') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.tickets*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
      ...
      @can('catalogs.view')
        <a href="{{ route('admin.catalogs') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.catalogs*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
          <x-lucide-box class="w-5 h-auto" />
          <span class="font-semibold">{{ __('admin/navigation.catalogs') }}</span>
        </a>
      @endcan
      @can('packages.view')
        <a href="{{ route('admin.packages') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.packages*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
          <x-lucide-package class="w-5 h-auto" />
          <span class="font-semibold">{{ __('admin/navigation.packages') }}</span>
        </a>
      @endcan
      @can('variants.view')
        <a href="{{ route('admin.variants') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.variants*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
          <x-lucide-boxes class="w-5 h-auto" />
          <span class="font-semibold">{{ __('admin/navigation.variants') }}</span>
        </a>
      @endcan
      @can('coupons.view')
        <a href="{{ route('admin.coupons') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.coupons*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
      ...
      <a href="{{ route('admin.settings') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.settings*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
        <x-lucide-settings class="w-5 h-auto" />
        <span class="font-semibold">{{ __('admin/navigation.settings') }}</span>
      </a>
      @can('plugins.view')
        <a href="{{ route('admin.plugins') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.plugins*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
          <x-lucide-puzzle class="w-5 h-auto" />
          <span class="font-semibold">{{ __('admin/navigation.plugins') }}</span>
        </a>
      @endcan
      @can('themes.view')
        <a href="{{ route('admin.themes') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.themes*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
          <x-lucide-paintbrush class="w-5 h-auto" />
          <span class="font-semibold">{{ __('admin/navigation.themes') }}</span>
        </a>
      @endcan
      @can('automations.view')
        <a href="{{ route('admin.automations') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.automations*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
          <x-lucide-clock class="w-5 h-auto" />
          <span class="font-semibold">{{ __('admin/navigation.automations') }}</span>
        </a>
      @endcan
      @can('tasks.view')
        <a href="{{ route('admin.tasks') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.tasks*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
          <x-lucide-clipboard-list class="w-5 h-auto" />
          <span class="font-semibold">{{ __('admin/navigation.tasks') }}</span>
        </a>
      @endcan
      <a href="{{ route('admin.audits') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.audits*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
      ...
      @endcan
      @can('gateways.view')
        <a href="{{ route('admin.gateways') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.gateways*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
          <x-lucide-credit-card class="w-5 h-auto" />
          <span class="font-semibold">{{ __('admin/navigation.gateways') }}</span>
        </a>
      @endcan
      @can('modules.view')
        <a href="{{ route('admin.modules') }}" class="flex gap-2 items-center {{ request()->routeIs('admin.modules*') ? 'bg-billmora-primary-500 text-white' : 'hover:bg-billmora-primary-500' }} px-3 py-3 rounded-lg text-slate-600 hover:text-white transition-colors duration-300">
