...
<div class="flex flex-col gap-4">
    <div class="flex flex-col md:flex-row gap-4 justify-between items-center">
        ...
        <div class="ml-auto flex gap-2">
            @can('plugins.install')
                <x-admin::modal.trigger modal="installModal" variant="open" class="flex gap-1 items-center bg-billmora-primary hover:bg-billmora-primary-hover px-3 py-2 text-white rounded-lg transition-colors ease-in-out duration-150 cursor-pointer">
