        ...
        <div class="grid gap-2">
            ...
            <div class="bg-white p-4 border-2 border-billmora-2 rounded-2xl">
                <div class="grid">
                    ...
                    <a href="{{ route('admin.users.summary', ['user' => $ticket->user->id]) }}" class="text-slate-500 font-medium">
                ...
                <hr class="border-t-2 border-billmora-2 my-2">
                <div class="grid">
                    <h4 class="text-sm text-slate-400 font-semibold">{{ __('admin/tickets.ticket_priority_label') }}</h4>
                    <span class="text-slate-500 font-medium">{{ ucwords($ticket->priority) }}</span>
                </div>
                <hr class="border-t-2 border-billmora-2 my-2">
                <div class="grid">
                    <h4 class="text-sm text-slate-400 font-semibold">{{ __('admin/tickets.ticket_department_label') }}</h4>
                    <span class="text-slate-500 font-medium">{{ ucwords($ticket->department ?? '-') }}</span>
                </div>
                <hr class="border-t-2 border-billmora-2 my-2">
                <div class="grid">
                    <h4 class="text-sm text-slate-400 font-semibold">{{ __('admin/tickets.ticket_assigned_label') }}</h4>
