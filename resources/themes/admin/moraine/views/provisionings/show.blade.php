...
<div class="flex flex-col gap-4">
    <div class="flex flex-col md:flex-row gap-4 justify-between items-center">
        @can('provisionings.instance.create')
                        ...
                        @foreach ($instances as $instance)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium space-x-2">
                                    @can('provisionings.instance.update')
                                    ...
                                    @endcan
                                    @can('provisionings.instance.delete')
    ...
    @can('provisionings.instance.delete')
        @foreach ($instances as $instance)
            <x-admin::modal.content
                ...
                <form action="{{ route('admin.provisionings.instance.destroy', ['driver' => $driver, 'instance' => $instance->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')
