...
class ThemeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $themes = [
            ...
            'portal' => [
                'hero_title' => 'Grow your business with Billmora!',
                'hero_description' => 'Billmora — short for Billing Management, Operation, and Recurring Automation — is a free, open-source platform built for hosting providers and service businesses that need full control over their billing infrastructure without paying recurring licensing fees.',
                'catalog_title' => 'Our Catalogs',
                'catalog_description' => 'What do you want to buy?',
                'cta_title' => 'Ready to get started?',
                'cta_description' => 'Create your free account today and take full control of your services. No credit card required.',
