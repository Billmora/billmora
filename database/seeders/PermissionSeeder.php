...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            'coupons.delete',
            'provisionings.view',
            'provisionings.install',
            'provisionings.uninstall',
            'provisionings.instance.view',
            'provisionings.instance.create',
            'provisionings.instance.update',
            'provisionings.instance.delete',
