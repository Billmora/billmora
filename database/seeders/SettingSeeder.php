...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            ['category' => 'general', 'key' => 'ordering_redirect', 'value' => 'invoice'],
            ...
            ['category' => 'general', 'key' => 'service_number_increment', 'value' => 1],
            ['category' => 'general', 'key' => 'service_number_padding', 'value' => 4],
            ['category' => 'general', 'key' => 'service_number_format', 'value' => 'SVC-{number}'],
            ['category' => 'general', 'key' => 'domain_registration_enabled', 'value' => true],
            ['category' => 'general', 'key' => 'domain_transfer_enabled', 'value' => true],
            ['category' => 'general', 'key' => 'domain_number_increment', 'value' => 1],
            ['category' => 'general', 'key' => 'domain_number_padding', 'value' => 4],
            ['category' => 'general', 'key' => 'domain_number_format', 'value' => 'DOM-{number}'],
            ...
            ['category' => 'general', 'key' => 'credit_auto_payment', 'value' => false],
            ...
            ['category' => 'general', 'key' => 'misc_avatar_provider', 'value' => 'dicebear-thumbs'],
            ...
            ['category' => 'automation', 'key' => 'user_inactive_days', 'value' => 30],
