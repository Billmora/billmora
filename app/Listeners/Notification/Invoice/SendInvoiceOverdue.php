...
use App\Events\Invoice\Overdue;
...
class SendInvoiceOverdue implements ShouldQueue
{
     ...
     * Handle the event.
     */
    public function handle(Overdue $event): void
    {
        $invoice = $event->invoice;
        $client = $invoice->user;
        $noticeLevel = $event->noticeLevel;
        ...
        $notificationKey = 'invoice_' . $noticeLevel;
