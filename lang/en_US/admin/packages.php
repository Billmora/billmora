...
return [
    ...
    'fields' => [
        'label' => 'Label',
        'label_helper' => 'Enter a user-friendly label for this field (e.g., Character Name).',
        'name' => 'Internal Name',
        'name_helper' => 'Leave empty to auto-generate from label. Used internally for mapping.',
        'type' => 'Type',
        'type_helper' => 'Select the input type for this field.',
        'helper' => 'Helper Text',
        ...
        'condition_field' => 'Target Field Name',
